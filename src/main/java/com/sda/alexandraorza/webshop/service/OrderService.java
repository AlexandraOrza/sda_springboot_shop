...
import com.sda.alexandraorza.webshop.model.*;
import com.sda.alexandraorza.webshop.repository.BillRepository;
import com.sda.alexandraorza.webshop.repository.CustomerRepository;
import com.sda.alexandraorza.webshop.repository.OrderRepository;
        ...
        if (customer.isPresent()) {
            ...
            for (Long productId : orderDTO.getProductIds()) {
                ...
                if (product.isPresent()) {
                    ...
                    throw new IllegalArgumentException("No product was found in DB for the given Id:" + productId);
                }
            }
